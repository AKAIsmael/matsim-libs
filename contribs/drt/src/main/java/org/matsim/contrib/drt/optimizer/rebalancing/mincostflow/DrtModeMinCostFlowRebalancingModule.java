	...
	public void install() {
		...
		switch (params.getZonalDemandAggregatorType()) {
			case PreviousIteration:
				...
				addEventHandlerBinding().to(PreviousIterationZonalDRTDemandAggregator.class);
				break;
			case TimeDependentActivityBased:
				...
				addEventHandlerBinding().to(TimeDependentActivityBasedZonalDemandAggregator.class);
				break;
